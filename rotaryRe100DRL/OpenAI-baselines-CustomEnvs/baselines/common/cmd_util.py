...
from CustomEnvs.VirtualEnv.VirtualEnv_wrapper import make_virtual_env

def make_vec_env(env_id, env_type, num_env, seed, wrapper_kwargs=None, start_index=0, reward_scale=1.0,
                 steps_until_done=400, cont=False, norm=False):
    """
...
def common_arg_parser():
    ...
    parser.add_argument('--num_env', help='Number of environment copies being run in parallel.When not specified, set '
                                          'to number of cpus for Atari, and to 1 for Mujoco', default=None, type=int)
    parser.add_argument('--reward_scale', help='Reward scale factor. Default: 1.0', default=1.0, type=float)
    parser.add_argument('--save_path', help='Path to save trained model to', default=None, type=str)
    parser.add_argument('--play', default=False, action='store_true')

    parser.add_argument('--env_steps', help='Steps until environment stops (TempControlEnv)', type=int, default=400)
    parser.add_argument('--env_cont', help='Continuous action space (TempControlEnv)',
                        default=False, action='store_true')
    parser.add_argument('--env_norm', help='Normalized observation and action spaces (TempControlEnv)',
                        default=False, action='store_true')
